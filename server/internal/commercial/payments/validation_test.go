...
func TestValidateCheckoutNormalizesCurrency(t *testing.T) {
	...
	if request.Reference != "wallet-topup-1" || request.Currency != "GHS" || request.Email != "buyer@example.com" {
...
func TestValidateCheckoutRejectsUntrustedCommercialInputs(t *testing.T) {
	tests := []CheckoutRequest{
		...
		{Reference: "wallet-topup-1", AmountMinor: 0, Currency: "GHS", Email: "buyer@example.com"},
		{Reference: "wallet-topup-1", AmountMinor: 1, Currency: "cedi", Email: "buyer@example.com"},
		{Reference: "wallet-topup-1", AmountMinor: 1, Currency: "GHS"},
		{Reference: "wallet-topup-1", AmountMinor: 1, Currency: "GHS", Email: "buyer@example.com", CallbackURL: "http://example.com/return"},
	}
