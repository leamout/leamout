...
func (h *Handler) index(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "load subscribers", http.StatusInternalServerError)
		return
	}
...
func (h *Handler) detail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "load subscribers detail", http.StatusInternalServerError)
		return
	}
...
func render(w http.ResponseWriter, r *http.Request, view templ.Component) {
	...
	if err := view.Render(r.Context(), &body); err != nil {
		http.Error(w, "render subscribers view", http.StatusInternalServerError)
		return
	}
