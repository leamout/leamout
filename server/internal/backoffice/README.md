...
Generated `*_templ.go` files and `assets/public/static/css/tailwindcss.css` are build artifacts and are not committed.
...
- `assets` owns the embedded public asset tree.
