...
func (h *Handler) index(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "load sip-domains", http.StatusInternalServerError)
		return
	}
	render(w, r, Page(items))
}
func (h *Handler) detail(w http.ResponseWriter, r *http.Request) {
	id, err := uuid.Parse(chi.URLParam(r, "domain_id"))
	if err != nil {
		http.NotFound(w, r)
		return
	}
	...
	if err != nil {
		http.Error(w, "load sip-domains detail", http.StatusInternalServerError)
		return
	}
...
func render(w http.ResponseWriter, r *http.Request, view templ.Component) {
	...
	if err := view.Render(r.Context(), &body); err != nil {
		http.Error(w, "render sip-domains view", http.StatusInternalServerError)
		return
	}
