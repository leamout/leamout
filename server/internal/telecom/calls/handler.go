...
func (h *Handler) Transfer(w http.ResponseWriter, r *http.Request) {
	...
	h.control(w, r, &req, func(org, id uuid.UUID) error { return h.service.Transfer(r.Context(), org, id, req) })
}
func (h *Handler) Hold(w http.ResponseWriter, r *http.Request) {
	h.control(w, r, nil, func(org, id uuid.UUID) error { return h.service.Hold(r.Context(), org, id) })
}
func (h *Handler) Unhold(w http.ResponseWriter, r *http.Request) {
	h.control(w, r, nil, func(org, id uuid.UUID) error { return h.service.Unhold(r.Context(), org, id) })
}
func (h *Handler) Play(w http.ResponseWriter, r *http.Request) {
	var req PlayRequest
	h.control(w, r, &req, func(org, id uuid.UUID) error { return h.service.Play(r.Context(), org, id, req) })
}
func (h *Handler) Stop(w http.ResponseWriter, r *http.Request) {
	h.control(w, r, nil, func(org, id uuid.UUID) error { return h.service.Stop(r.Context(), org, id) })
}
func (h *Handler) Record(w http.ResponseWriter, r *http.Request) {
	var req RecordRequest
	h.control(w, r, &req, func(org, id uuid.UUID) error { return h.service.Record(r.Context(), org, id, req) })
}
func (h *Handler) DTMF(w http.ResponseWriter, r *http.Request) {
	var req DTMFRequest
	h.control(w, r, &req, func(org, id uuid.UUID) error { return h.service.DTMF(r.Context(), org, id, req) })
}
func (h *Handler) control(w http.ResponseWriter, r *http.Request, body any, action func(uuid.UUID, uuid.UUID) error) {
	org, id, err := requestCallIDs(r)
	...
	httputil.OK(w, map[string]string{"message": "call control action completed"})
}
...
func listParams(r *http.Request) (int32, int32, *string, error) {
	...
	if value := r.URL.Query().Get("limit"); value != "" {
		parsed, e := strconv.ParseInt(value, 10, 32)
		if e != nil {
