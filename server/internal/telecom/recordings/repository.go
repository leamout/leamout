...
func (r *Repository) List(ctx context.Context, organizationID uuid.UUID, offset, limit int32) ([]sqlc.Recording, error) {
	return r.queries.ListRecordings(ctx, sqlc.ListRecordingsParams{OrganizationID: organizationID, PageOffset: offset, PageLimit: limit})
}
func (r *Repository) Delete(ctx context.Context, organizationID, id uuid.UUID) (sqlc.Recording, error) {
	return r.queries.DeleteRecording(ctx, sqlc.DeleteRecordingParams{OrganizationID: organizationID, ID: id})
}
