...
func (r *Repository) Create(
	...
	return r.queries.CreateConference(ctx, sqlc.CreateConferenceParams{
		OrganizationID: org,
...
func (r *Repository) SetState(
	...
	return r.queries.UpdateConferenceState(ctx, sqlc.UpdateConferenceStateParams{
		OrganizationID: org,
		ID:             id,
		State:          state,
	})
...
func (r *Repository) CreateParticipant(
	...
	return r.queries.CreateConferenceParticipant(ctx, sqlc.CreateConferenceParticipantParams{
		OrganizationID:    org,
...
func (r *Repository) SetParticipant(
	ctx context.Context,
	org uuid.UUID,
	id uuid.UUID,
	state string,
	...
	return r.queries.UpdateConferenceParticipantState(ctx, sqlc.UpdateConferenceParticipantStateParams{
		OrganizationID: org,
		ID:             id,
		State:          state,
		Muted:          muted,
