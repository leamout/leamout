...
func (s *Service) Create(ctx context.Context, org uuid.UUID, req CreateRequest) (sqlc.Conference, error) {
...
func (s *Service) Get(ctx context.Context, org, id uuid.UUID) (sqlc.Conference, error) {
	if err := validateOrganizationID(org); err != nil {
		return sqlc.Conference{}, err
	}
...
func (s *Service) List(ctx context.Context, org uuid.UUID, offset, limit int32) ([]sqlc.Conference, error) {
	if err := validateOrganizationID(org); err != nil {
		return nil, err
	}
	if offset < 0 {
...
func (s *Service) End(ctx context.Context, org, id uuid.UUID) (sqlc.Conference, error) {
...
func (s *Service) AddParticipant(ctx context.Context, org, conferenceID uuid.UUID, req AddParticipantRequest) (sqlc.ConferenceParticipant, error) {
...
func (s *Service) ListParticipants(ctx context.Context, org, conferenceID uuid.UUID) ([]sqlc.ConferenceParticipant, error) {
...
func (s *Service) participant(ctx context.Context, org, conferenceID, id uuid.UUID) (sqlc.ConferenceParticipant, error) {
	if _, err := s.Get(ctx, org, conferenceID); err != nil {
		return sqlc.ConferenceParticipant{}, err
	}
...
func (s *Service) SetParticipant(ctx context.Context, org, conferenceID, id uuid.UUID, state string, muted, deaf *bool) (sqlc.ConferenceParticipant, error) {
