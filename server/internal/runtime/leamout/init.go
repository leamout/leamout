...
func renderRuntimeEnv(state deploymentState, secrets deploymentSecrets) []byte {
	return []byte(strings.Join([]string{
		"# Generated by `leamout init`. Preserve generated secret values.",
		"# Optional managed-provider and public-network settings below may be configured by the operator.",
		"APP_ENV=production",
